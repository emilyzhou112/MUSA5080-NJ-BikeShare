...
nycbike <- read.csv("/Users/emzhou/Downloads/JC-202308-citibike-tripdata.csv")
tidycensus::census_api_key("e79f3706b6d61249968c6ce88794f6f556e5bf3d", overwrite = TRUE)
```


```{r obtain census data and geometry, warning=FALSE, message=FALSE, results='hide', cache=TRUE}
...
```{r animate map temporal viz, message=FALSE, warning=FALSE, cache=TRUE, results='hide', fig.show='animate'}

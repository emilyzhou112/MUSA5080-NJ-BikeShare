...
![animate]("https://raw.githubusercontent.com/emilyzhou112/MUSA5080-NJ-BikeShare/main/animation.gif")
...
We also need to check if our prediction generalized across space and time. To do that, we mapped the error 
